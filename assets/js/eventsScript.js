...
var getEventData = function () {
  ...
  if (city === '') {
    ...
    var eventsAPI =
      'https://app.ticketmaster.com/discovery/v2/events.json?countryCode=CA&size=15&sort=relevance,desc&city=' +
      city +
      '&startDateTime=' +
      currentDate +
      '&endDateTime=' +
...
var display5Records = function (listOfEvents) {
  ...
  showMoreEventsBtn.className =
    'button is-medium is-danger is-light show-more-button is-flex mt-5';
